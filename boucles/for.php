...
echo "8.Les mois depuis le debut de l'annee : <br><br>";
// for ($i = 0; $i < 12; $i++) {
//     echo $mois[$i] . '<br>';
//} 

//fonctionne aussi avec un foreach :
...
//syntax : foreach($tableau as $clef => $valeur){}
...
$college = array(
  ...
  'Troisième' => array(
    array('Nom' => 'Barra', 'Prenom' => 'Marius'),
    array('Nom' => 'Pépone', 'Prenom' => 'Luciano'),
    array('Nom' => 'Marshall', 'Prenom' => 'Paula'),
    array('Nom' => 'Paris', 'Prenom' => 'Suze'),
  ),
);
...
foreach ($college as $key => $value){
  ...
  foreach ($value as $key2 => $value2){
    echo $value2['Nom'] . " , " . $value2['Prenom'] . "<br>";
  } 
}
echo '<br><br>';
...
//  }
 ...
 foreach ($videotheque as $key => $value){
  echo "Nom : " . $value['nom']. "<br>" ."Date :" . $value['date'] . "<br>" . "Réalisateur : " . $value['realisateur'] . "<br>";
 foreach ($value as $key2 => $value2){
   foreach ($value2 as $key3 => $value3){
    echo  "Acteur : " . $value3 . "\n" . "<br>";
   }
...
//ajoutez votre code ici
foreach ($videotheque as $key => $value){
  echo "Nom : " .  $value['nom'] . "<br>" . "Date : " . $value['date'] . "<br>" . "Réalisateur : " . $value['realisateur'] . "<br>" . "Synopsis : " .$value['synopsis'] . "<br>";
  foreach ($value as $key2 => $value2){
    foreach ($value2 as $key3 => $value3){
      echo "Acteurs : " . $value3 . "\n" . "<br>";
    }
